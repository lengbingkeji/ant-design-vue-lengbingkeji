<template>
  <a-card :bordered="false">
    ...
    <test-order-main-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
...
<script>
  ...
  import TestOrderMainModal from './modules/TestOrderMainModal'
  import {filterMultiDictText} from '@/components/dict/JDictSelectUtil'
  import '@/assets/less/TableExpand.less'

  export default {
    name: "TestOrderMainList",
    ...
    data () {
      return {
        ...
        url: {
          list: "/Test/testOrderMain/list",
          delete: "/Test/testOrderMain/delete",
          deleteBatch: "/Test/testOrderMain/deleteBatch",
          exportXlsUrl: "/Test/testOrderMain/exportXls",
          importExcelUrl: "Test/testOrderMain/importExcel",
